...
try{
    ...
    // degine namespace
    Ext.ns('Wow.locale','Wow.locale.exception');
    
    // Wow locale
    Wow.locale.ActiveText = 'Sim';
    Wow.locale.InactiveText = 'Não';
    Wow.locale.YesText = 'Sim';
    Wow.locale.NoText = 'Não';

    // exception
    Wow.locale.exception.InfoMessage = 'OCORREU UM ERRO NO SISTEMA:<br>';
